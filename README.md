...
Phase 0 is a sample-only foundation. It establishes the stable HTML, CSS, JavaScript, data, UI-state, and persistence seams without real restaurant data or product matching.
